...
// ─────────────────────────────────────────────────────────────────────────────
const _kRoutes = [
  _RouteItem(from: 'London', to: 'Lagos',   tag: 'Popular',     image: 'assets/images/london-lagos-route.svg'),
  _RouteItem(from: 'Paris',  to: 'Toronto', tag: 'Fast-Moving', image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=800&auto=format&fit=crop'),
];
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final services = isCarrier
        ? [
            _ServiceItem(title: l10n.serviceSeeRequests, description: l10n.serviceSeeRequestsDesc, color: const Color(0xFFEEEBFF), icon: Icons.inbox_rounded, route: '/requests', isPrimary: true),
            _ServiceItem(title: l10n.servicePublishTrip, description: l10n.servicePublishTripDesc, color: const Color(0xFFF1F5FF), icon: Icons.flight_takeoff_rounded, route: '/post-trip'),
            _ServiceItem(title: l10n.serviceMessages, description: l10n.serviceMessagesDesc, color: const Color(0xFFFFF1F1), icon: Icons.chat_bubble_outline_rounded, route: '/messages'),
          ]
        : [
            _ServiceItem(title: l10n.serviceSendPackage, description: l10n.serviceSendPackageDesc, color: const Color(0xFFEEEBFF), icon: Icons.send_rounded, route: '/create-shipment', isPrimary: true),
            _ServiceItem(title: l10n.serviceBuyItems, description: l10n.serviceBuyItemsDesc, color: const Color(0xFFF1F5FF), icon: Icons.shopping_bag_outlined, route: '/services/buy-items'),
            _ServiceItem(title: l10n.serviceGiftItems, description: l10n.serviceGiftItemsDesc, color: const Color(0xFFFFF1F1), icon: Icons.favorite_border_rounded, route: '/services/gift-items'),
          ];
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Image.asset('assets/images/bago-logo.png', width: 88, fit: BoxFit.contain),
                    const Spacer(),
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: user?.profilePicture != null
                            ...
                            : Center(child: Text(avatarLetter, style: AppTextStyles.labelMd.copyWith(color: AppColors.black, fontWeight: FontWeight.w800))),
                      ),
                    ),
                  ],
                ),
                ...
                Text(
                  isCarrier ? l10n.welcomeBackName(firstName) : l10n.homeSenderHeadline,
                  style: AppTextStyles.displaySm.copyWith(color: AppColors.black, fontWeight: FontWeight.w800, height: 1.1),
                  maxLines: 2,
                ),
                const SizedBox(height: 6),
                Text(
                  isCarrier ? l10n.homeCarrierSubtitle : l10n.homeSenderSubtitle,
                ...
                _RecentActivityList(
                  ...
                  onViewAll: () => context.go(isCarrier ? '/requests' : '/shipments'),
                ),

                const SizedBox(height: 20),

                // ── Services ─────────────────────────────────────────────
                Text(l10n.whatDoYouWantToDo, style: AppTextStyles.h3.copyWith(fontWeight: FontWeight.w800, color: AppColors.black)),
                const SizedBox(height: 10),
                SizedBox(
                  height: 110,
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) => _ServiceCard(item: services[i]),
                  ),
                ),
                const SizedBox(height: 16),

                // ── Top Destinations ─────────────────────────────────────
                Text(l10n.topDestination, style: AppTextStyles.h3.copyWith(fontWeight: FontWeight.w800, color: AppColors.black)),
                const SizedBox(height: 10),
                SizedBox(
                  height: 160,
                  child: ListView.separated(
...
class _SenderHero extends StatelessWidget {
  const _SenderHero({
    ...
    required this.onFromTap, required this.onToTap, required this.onDateTap,
...
class _CarrierHero extends StatelessWidget {
  const _CarrierHero({required this.balance, required this.currency, required this.onPostTrip});
              ...
              Column(
                ...
                children: [
                  Text(l10n.earnedBalance,
                      style: AppTextStyles.labelXs.copyWith(color: Colors.white.withOpacity(0.5), fontWeight: FontWeight.w800, letterSpacing: 1.1)),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(l10n.publishNewItinerary,
                      style: AppTextStyles.buttonMd.copyWith(color: AppColors.black, fontWeight: FontWeight.w800)),
                ],
              ),
            ),
          ),
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(child: Text(l10n.globalLocationSearch, style: AppTextStyles.h3.copyWith(fontWeight: FontWeight.w800))),
                GestureDetector(
...
class _CalendarSheetState extends State<_CalendarSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final monthLabel = _monthName(_currentMonth.month) + ' ${_currentMonth.year}';
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(monthLabel, style: AppTextStyles.h3.copyWith(fontWeight: FontWeight.w900)),
                GestureDetector(onTap: _nextMonth, child: const Icon(Icons.chevron_right, color: AppColors.primary)),
              ],
            ),
          ),
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _selected == null ? null : () {
                  final formatted = '${_monthName(_selected!.month).substring(0, 3)} ${_selected!.day}, ${_selected!.year}';
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: isPrimary
                ? [BoxShadow(color: AppColors.primary.withOpacity(0.22), blurRadius: 12, offset: const Offset(0, 5))]
                : highlight
        ...
        route.image.startsWith('assets/')
            ...
            : CachedNetworkImage(
                ...
                errorWidget: (_, __, ___) => Container(
                  ...
                  alignment: Alignment.center,
                  child: const Icon(Icons.public_rounded, color: AppColors.gray500, size: 32),
                ),
              ),
        Container(
          decoration: BoxDecoration(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(route.tag,
                      style: AppTextStyles.labelXs.copyWith(color: AppColors.black, fontWeight: FontWeight.w800)),
                ),
              ],
            ),
          ),
...
class _RecentActivityList extends StatelessWidget {
  ...
  Color _statusColor(RequestModel r) {
    final s = r.status.apiValue;
    if (s == 'completed') return const Color(0xFF059669);
    if (s == 'delivered') return const Color(0xFF059669);
    if (s == 'intransit' || s == 'delivering') return AppColors.primary;
    if (s == 'accepted') return const Color(0xFF0891B2);
    if (s == 'rejected' || s == 'cancelled') return const Color(0xFFDC2626);
    return AppColors.gray400;
  }

  Color _statusBg(RequestModel r) => _statusColor(r).withOpacity(0.10);

  IconData _statusIcon(RequestModel r) {
    final s = r.status.apiValue;
    if (s == 'completed' || s == 'delivered') return Icons.check_circle_rounded;
    if (s == 'intransit') return Icons.flight_takeoff_rounded;
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: AppTextStyles.bodyMd.copyWith(color: AppColors.gray500, fontWeight: FontWeight.w600),
                ),
              ),
          ...
          child: Column(
            children: [
              ...requests.asMap().entries.map((entry) {
                ...
                final isLast = i == requests.length - 1;
                final counterpart = isCarrier ? (req.senderName ?? 'Sender') : (req.carrierName ?? 'Traveler');
                final route = [req.fromLocation, req.toLocation]
                    .where((e) => e != null && e.isNotEmpty)
                    .join(' → ');
                final amount = req.agreedPrice > 0
                    ? '${req.currency} ${req.agreedPrice.toStringAsFixed(2)}'
                    : '—';
                return InkWell(
                  onTap: () => context.push('/shipment-request/${req.id}', extra: req),
                  borderRadius: isLast
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: isLast ? null : const Border(bottom: BorderSide(color: Colors.white, width: 1.5)),
                    ),
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Icon(_statusIcon(req), color: _statusColor(req), size: 20),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                route.isNotEmpty ? route : req.packageTitle ?? 'Package',
                                style: AppTextStyles.bodySm.copyWith(color: AppColors.gray500, fontWeight: FontWeight.w500),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ],
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: AppTextStyles.bodySm.copyWith(color: AppColors.gray400, fontWeight: FontWeight.w500),
                            ),
                          ],
                        ),
                      ],
...
// ─────────────────────────────────────────────────────────────────────────────
class _ServiceItem {
  const _ServiceItem({required this.title, required this.description, required this.color, required this.icon, required this.route, this.isPrimary = false});
...
class _RouteItem {
  const _RouteItem({required this.from, required this.to, required this.tag, required this.image});
