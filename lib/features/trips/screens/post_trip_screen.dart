...
class PostTripScreen extends ConsumerStatefulWidget {
  const PostTripScreen(
      {super.key, this.tripId, this.initialTrip, this.redoTrip});

  final String? tripId;
  final TripModel? initialTrip;
  final TripModel? redoTrip;
...
class _PostTripScreenState extends ConsumerState<PostTripScreen> {
  ...
  void initState() {
    ...
    if (!_isEditMode) {
      _resetForCreate();
      if (widget.redoTrip != null) {
        _populateFields(widget.redoTrip!, clearSchedule: true);
      }
    }
    _bootstrapCurrency();
    if (_isEditMode) {
  ...
  void _populateFields(dynamic trip, {bool clearSchedule = false}) {
    ...
    setState(() {
      ...
      _date = clearSchedule ? '' : dateLabel;
      _time = clearSchedule ? '' : '$hour:$minute $period';
      _hour = clearSchedule ? '08' : hour;
      _minute = clearSchedule ? '00' : minute;
      _period = clearSchedule ? 'AM' : period;
      _selectedDate = clearSchedule ? null : departure;
      _currentMonth =
          clearSchedule ? DateTime.now() : departure ?? _currentMonth;
...
const _kDefaultLocations = [
  ...
  _LocationResult(
      ...
      lon: -79.3832),
  _LocationResult(
      displayName: 'Houston, United States',
      countryCode: 'us',
      category: 'city',
      lat: 29.7604,
      lon: -95.3698),
  ...
  _LocationResult(
      ...
      lon: 7.4951),
  _LocationResult(
      displayName: 'Ibadan, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 7.3775,
      lon: 3.9470),
  _LocationResult(
      displayName: 'Port Harcourt, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 4.8156,
      lon: 7.0498),
  _LocationResult(
      ...
      lon: 8.5920),
  _LocationResult(
      displayName: 'Benin City, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 6.3350,
      lon: 5.6275),
  _LocationResult(
      ...
      lon: 7.5464),
  _LocationResult(
      displayName: 'Owerri, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 5.4836,
      lon: 7.0333),
  _LocationResult(
      displayName: 'Calabar, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 4.9517,
      lon: 8.3220),
  _LocationResult(
      displayName: 'Warri, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 5.5167,
      lon: 5.7500),
  _LocationResult(
      displayName: 'Asaba, Nigeria',
      countryCode: 'ng',
      category: 'city',
      lat: 6.2000,
      lon: 6.7333),
  ...
  _LocationResult(
      ...
      lon: -0.1870),
  _LocationResult(
      displayName: 'Kumasi, Ghana',
      countryCode: 'gh',
      category: 'city',
      lat: 6.6885,
      lon: -1.6244),
  _LocationResult(
      displayName: 'Dakar, Senegal',
      countryCode: 'sn',
      category: 'city',
      lat: 14.7167,
      lon: -17.4677),
  ...
  _LocationResult(
      ...
      lon: 36.8219),
  _LocationResult(
      displayName: 'Kampala, Uganda',
      countryCode: 'ug',
      category: 'city',
      lat: 0.3476,
      lon: 32.5825),
  _LocationResult(
      displayName: 'Dar es Salaam, Tanzania',
      countryCode: 'tz',
      category: 'city',
      lat: -6.7924,
      lon: 39.2083),
                      ...
                      : addr['municipality']?.toString().isNotEmpty == true
                          ...
                          : addr['village']?.toString().isNotEmpty == true
                              ...
                              : addr['suburb']?.toString().isNotEmpty == true
                                  ? addr['suburb']
                                  : addr['county']?.toString().isNotEmpty ==
                                          true
                                      ? addr['county']
