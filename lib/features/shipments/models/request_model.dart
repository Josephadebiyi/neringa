...
class RequestModel {
  ...
  factory RequestModel.fromJson(Map<String, dynamic> json) {
    ...
    return RequestModel(
      ...
      packageId: json['packageId']?.toString() ?? package?['_id']?.toString() ?? package?['id']?.toString() ?? '',
      tripId: json['tripId']?.toString() ?? json['trip']?.toString() ?? '',
      senderId: json['senderId']?.toString() ?? sender?['_id']?.toString() ?? sender?['id']?.toString() ?? '',
      carrierId: json['carrierId']?.toString() ?? json['travelerId']?.toString() ?? carrier?['_id']?.toString() ?? '',
      status: RequestStatus.fromString(json['status']?.toString()),
      agreedPrice: JsonParser.parseDoubleFirst(json, ['agreedPrice', 'price', 'amount']),
      ...
      senderEmail: sender?['email']?.toString() ?? json['senderEmail']?.toString(),
      ...
      originCountry:
          json['originCountry']?.toString() ?? package?['fromCountry']?.toString(),
      destinationCountry:
          json['destinationCountry']?.toString() ?? package?['toCountry']?.toString(),
  ...
  static String? _nestedDate(Map<String, dynamic> json, String parentKey, String childKey) {
