...
class CurrencyConversionHelper {
  ...
  /// Collection currencies listed by Flutterwave's payment-method matrix.
  /// Payout support is a separate and smaller set.
  static const Set<String> flutterwavePaymentCurrencies = {
    'USD',
    'EUR',
    'GBP',
    'NGN',
  ...
  static const Set<String> _europeCountryCodes = {
    'AL',
    'AD',
    'AT',
    'BY',
  ...
  /// Uses the country's own currency where Flutterwave supports collection.
  /// Unsupported European currencies settle checkout in EUR; other unsupported
  /// regions use Flutterwave's broadly supported USD collection corridor.
  static String paymentCurrencyForCountry(CountryCurrencyData country) {
    final native = country.currency.toUpperCase();
    if (flutterwavePaymentCurrencies.contains(native)) return native;
    if (_europeCountryCodes.contains(country.code.toUpperCase())) return 'EUR';
    return 'USD';
  }
  ...
  static Map<String, double> _runtimeUsdRates =
      Map<String, double>.from(_defaultUsdRates);
  static List<String> _runtimeSupportedCurrencies =
      _defaultUsdRates.keys.toList();
