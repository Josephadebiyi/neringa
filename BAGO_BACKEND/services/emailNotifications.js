  ...
  try {
    const content = `
      ...
      <div style="background:#ecfdf5; padding:20px; border-radius:8px; margin:24px 0; border-left:4px solid #10b981;">
        ...
        <p style="margin:0 0 8px; font-size:14px; color:#374151;"><strong>Price:</strong> ${trip.pricePerKg} ${trip.currency || 'USD'} per kg</p>
        <p style="margin:0; font-size:14px; color:#374151;"><strong>Available Space:</strong> ${trip.availableKg} kg</p>
      </div>
      <p style="margin:0 0 18px; font-family:Arial, sans-serif; font-size:14px; color:#374151; line-height:1.6;">
