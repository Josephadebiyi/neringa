...
async function buildUserResponse(user) {
  ...
  return {
    ...
    businessGracePeriodStartedAt: user.businessGracePeriodStartedAt || null,
    email: user.email,
    phone: user.phone,
    ...
    payout_currency: user.payoutCurrency || null,
    payoutProvider: user.payoutProvider || user.paymentGateway || null,
    payout_provider: user.payoutProvider || user.paymentGateway || null,
    payoutStatus: user.payoutStatus || null,
    payout_status: user.payoutStatus || null,
...
export async function getWallet(req, res) {
  try {
    ...
    res.status(200).json({
      ...
      display_currency: wallet.display_currency || wallet.currency,
      walletDisplayCurrency: wallet.walletDisplayCurrency || wallet.displayCurrency || wallet.currency,
      wallet_display_currency: wallet.wallet_display_currency || wallet.display_currency || wallet.currency,
      ...
      transactions: wallet.transactions || wallet.history,
    ...
    try {
      ...
      return res.status(200).json({
        ...
        walletDisplayCurrency: currency,
        wallet_display_currency: currency,
        displayBalance: balance,
        display_balance: balance,
        walletDisplayBalance: balance,
        wallet_display_balance: balance,
        availableDisplayBalance: balance,
        available_display_balance: balance,
        displayEscrowBalance: escrowBalance,
        display_escrow_balance: escrowBalance,
        escrowDisplayBalance: escrowBalance,
        escrow_display_balance: escrowBalance,
        displayConversionStatus: 'degraded',
        display_conversion_status: 'degraded',
        allTimeReceived: 0,
        allTimeExpenses: 0,
        heldEarnings: 0,
        transactions: [],
