...
export const Profile = async (req, res, next) => {
  try {
    ...
    const findUser = wallet
      ? {
          ...user,
          balance: wallet.displayBalance ?? wallet.balance,
          walletBalance: wallet.walletDisplayBalance ?? wallet.displayBalance ?? wallet.balance,
          wallet_balance: wallet.wallet_display_balance ?? wallet.display_balance ?? wallet.balance,
          availableBalance: wallet.availableDisplayBalance ?? wallet.displayBalance ?? wallet.balance,
          available_balance: wallet.available_display_balance ?? wallet.display_balance ?? wallet.balance,
          escrowBalance: wallet.escrowDisplayBalance ?? wallet.displayEscrowBalance ?? wallet.escrowBalance,
          escrow_balance: wallet.escrow_display_balance ?? wallet.display_escrow_balance ?? wallet.escrowBalance,
          ...
          displayCurrency: wallet.displayCurrency || wallet.currency || user.currency,
          display_currency: wallet.display_currency || wallet.currency || user.currency,
          walletDisplayCurrency: wallet.walletDisplayCurrency || wallet.displayCurrency || wallet.currency || user.currency,
          wallet_display_currency: wallet.wallet_display_currency || wallet.display_currency || wallet.currency || user.currency,
          displayBalance: wallet.displayBalance ?? wallet.balance,
          display_balance: wallet.display_balance ?? wallet.balance,
          walletDisplayBalance: wallet.walletDisplayBalance ?? wallet.displayBalance ?? wallet.balance,
          wallet_display_balance: wallet.wallet_display_balance ?? wallet.display_balance ?? wallet.balance,
          availableDisplayBalance: wallet.availableDisplayBalance ?? wallet.displayBalance ?? wallet.balance,
          available_display_balance: wallet.available_display_balance ?? wallet.display_balance ?? wallet.balance,
          displayEscrowBalance: wallet.displayEscrowBalance ?? wallet.escrowBalance,
          display_escrow_balance: wallet.display_escrow_balance ?? wallet.escrowBalance,
          escrowDisplayBalance: wallet.escrowDisplayBalance ?? wallet.displayEscrowBalance ?? wallet.escrowBalance,
          ...
          currency: wallet.displayCurrency || wallet.display_currency || user.currency || wallet.currency,
          balanceHistory,
