...
function normalizeUser(row) {
  ...
  return {
    ...
    identityFieldsLocked: row.identity_fields_locked ?? false,
    verifiedFullLegalName: row.verified_full_legal_name || null,
    verifiedDateOfBirth: row.verified_date_of_birth || null,
