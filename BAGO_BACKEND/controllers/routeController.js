...
const COUNTRY_CURRENCY_MAP = {
  ...
  'RW': { currency: 'RWF', symbol: 'Fr', name: 'Rwandan Franc' },
  ...
  'CM': { currency: 'XAF', symbol: 'FCFA', name: 'Central African CFA Franc' },
  // Americas
  ...
  'PL': { currency: 'PLN', symbol: 'zł', name: 'Polish Złoty' },
...
export const getPricingForTrip = async (req, res) => {
  try {
    ...
    res.json({ success: true, exactMatch: true, route: rowToRoute(route), pricing, paymentGateway: 'flutterwave' });
  } catch (err) {
