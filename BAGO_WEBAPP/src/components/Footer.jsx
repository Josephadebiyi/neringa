        ...
        <footer className="bg-white text-[#012126] pt-16 pb-12 relative overflow-hidden border-t border-gray-100">
            ...
            <div className="px-6 md:px-12 max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-16 mb-24 relative z-10">
                ...
                <div className="flex flex-col gap-6">
                    <h4 className="font-black text-[#012126] text-lg uppercase tracking-widest text-[12px] opacity-40">Ship with Bago</h4>
                ...
                <div className="flex flex-col gap-6">
                    <h4 className="font-black text-[#012126] text-lg uppercase tracking-widest text-[12px] opacity-40">Travel with Bago</h4>
                    <div className="flex flex-col gap-4 text-[15px] font-bold text-gray-600">
                ...
                <div className="flex flex-col gap-6">
                    <h4 className="font-black text-[#012126] text-lg uppercase tracking-widest text-[12px] opacity-40">Find out more</h4>
                    <div className="flex flex-col gap-4 text-[15px] font-bold text-gray-600">
                ...
                <div className="flex flex-col gap-8">
                    <h4 className="font-black text-[#012126] text-lg uppercase tracking-widest text-[12px] opacity-40">Settings</h4>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="relative inline-block w-full">
                            ...
                            >
                                {languages.map(lang => (
                                    <option key={lang.code} value={lang.code} className="bg-white text-[#012126]">{lang.flag} {lang.name}</option>
                                ))}
                            </select>
            ...
            <div className="px-6 md:px-12 max-w-[1400px] mx-auto border-t border-gray-100 pt-12 flex flex-col md:flex-row justify-between items-center text-[13px] font-bold text-gray-400 relative z-10">
                ...
                <div className="flex flex-wrap justify-center gap-10">
                    ...
                    <p className="hover:text-[#012126] transition-colors cursor-default">Secure Escrow Payments</p>
