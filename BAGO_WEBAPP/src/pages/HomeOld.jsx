    ...
    return (
        <nav className="w-full bg-white border-b border-gray-100 py-3 px-6 md:px-12 flex justify-between items-center z-50 sticky top-0">
            ...
            <div className="hidden md:flex gap-10 items-center">
                <button onClick={() => navigate('/search?mode=carpool')} className="text-[#012126] font-semibold hover:text-[#5845D8] transition-colors cursor-pointer text-[15px]">Carpool</button>
                <button onClick={() => navigate('/search?mode=bus')} className="text-[#012126] font-semibold hover:text-[#5845D8] transition-colors cursor-pointer text-[15px]">Bus</button>
            </div>

            <div className="flex items-center gap-6">
                <button onClick={() => navigate('/search')} className="hidden md:flex items-center cursor-pointer group">
                    <Search size={22} className="text-[#012126] group-hover:text-[#5845D8]" />
                </button>
                ...
                <div className="flex items-center gap-5">
                    <div className="hidden md:flex items-center gap-2 cursor-pointer group">
                        <Smartphone size={20} className="text-[#012126] group-hover:text-[#5845D8]" />
                        <span className="text-[#012126] text-sm font-semibold group-hover:text-[#5845D8]">Get the app</span>
                    </div>
                    <Link to="/dashboard" className="flex items-center">
                        <UserCircle size={32} className="text-[#d9d9d9] hover:text-[#012126] transition-colors" />
                    </Link>
                </div>
            </div>
        </nav>
        ...
        <section className="relative w-full max-w-[1240px] mx-auto pt-10 px-6 md:px-12">
            <div className="flex flex-col md:flex-row gap-8 items-center justify-between mb-12">
                <div className="w-full md:w-[45%]">
                    <h1 className="text-5xl md:text-6xl font-black text-[#012126] leading-[1.1] tracking-tight">
                        Bus and carpool.<br />
                        Travel your way<br />
                        with Bago.
                    </h1>
            ...
            <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-gray-100 flex flex-col md:flex-row items-center w-full relative z-20 overflow-hidden">
                <div className="flex w-full md:w-1/4 items-center px-4 py-4 md:py-6 border-b md:border-b-0 md:border-r border-gray-100 group">
                    ...
                    <input
                        ...
                        className="outline-none text-[16px] font-medium w-full bg-transparent text-[#012126] placeholder-[#6B7280]"
                    />
                </div>
                <div className="flex w-full md:w-1/4 items-center px-4 py-4 md:py-6 border-b md:border-b-0 md:border-r border-gray-100 group">
                    <div className="w-4 h-4 rounded-full border-2 border-gray-400 mr-4 group-focus-within:border-[#5845D8]"></div>
                ...
                <div className="flex w-full md:w-[20%] items-center px-4 py-4 md:py-6 border-b md:border-b-0 md:border-r border-gray-100">
                    <Calendar size={20} className="text-[#6B7280] mr-3" />
                    <input
                        type="text"
                        placeholder="Today"
                        readOnly
                        className="outline-none text-[16px] font-medium w-full bg-transparent text-[#012126] cursor-pointer"
                    />
                </div>
                <div className="flex w-full md:w-[20%] items-center px-4 py-4 md:py-6">
                    <Users size={20} className="text-[#6B7280] mr-3" />
                    <input
                        type="text"
            ...
            <div className="mt-4 flex items-center gap-2 px-2">
                ...
                <label className="text-sm font-semibold text-[#012126]">Show stays</label>
            </div>
        </section>
    );
};
...
const PromoBar = () => {
    return (
        <section className="px-6 md:px-12 max-w-[1240px] mx-auto py-10">
            <div className="bg-[#012126] rounded-2xl p-8 md:p-12 text-center">
                ...
                <Link to="/post-trip" className="inline-flex items-center gap-3 bg-white text-[#012126] px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-all group">
...
const FeaturesSection = () => {
    const features = [
        ...
        {
            icon: <ShieldCheck size={32} className="text-[#012126]" />,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                {features.map((item, idx) => (
                    <div key={idx} className="flex flex-col gap-4">
                        ...
                        <h3 className="text-xl font-black text-[#012126]">{item.title}</h3>
...
const TripTypeSection = () => {
    ...
    return (
        <section className="px-6 md:px-12 max-w-[1240px] mx-auto py-16">
            <h2 className="text-3xl md:text-4xl font-black text-[#012126] text-center mb-12">How are you travelling today?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div onClick={() => navigate('/search?mode=bus')} className="bg-[#f0f4f5] rounded-2xl p-8 flex items-center gap-6 cursor-pointer hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1">
                        <h3 className="text-xl font-black text-[#012126]">By bus</h3>
                        <p className="text-[#6B7280] font-medium text-[15px]">Explore thousands of routes in Europe with incredible discounts</p>
                    </div>
                ...
                <div onClick={() => navigate('/search?mode=car')} className="bg-[#f0f4f5] rounded-2xl p-8 flex items-center gap-6 cursor-pointer hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1">
                        <h3 className="text-xl font-black text-[#012126]">By carpool</h3>
                        <p className="text-[#6B7280] font-medium text-[15px]">Share the costs to travel directly to your destination</p>
                    </div>
                    <div className="bg-[#5845D8] rounded-full p-2">
                        <ArrowRight size={20} className="text-white" />
                    </div>
    ...
    return (
        <section className="px-6 md:px-12 max-w-[1240px] mx-auto py-16">
            <div className="flex flex-col md:flex-row items-center gap-16">
                ...
                <div className="w-full md:w-1/2">
                    <h2 className="text-4xl md:text-5xl font-black text-[#012126] mb-6 leading-tight">
                        Automatic Ratings.<br />
                        More reliable<br />
                        rides.
                    </h2>
                    <p className="text-[#6B7280] text-[16px] font-medium leading-relaxed mb-8">
        ...
        <footer className="bg-[#f2f2f2] pt-16 pb-6 mt-10">
            <div className="px-6 md:px-12 max-w-[1240px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16">
                <div className="flex flex-col gap-5">
                    <h4 className="font-bold text-[#012126] text-md">Compare our ride options</h4>
                    <div className="flex flex-col gap-4 text-[14px] font-medium text-[#6B7280]">
                ...
                <div className="flex flex-col gap-5">
                    <h4 className="font-bold text-[#012126] text-md">Travel with carpool</h4>
                    <div className="flex flex-col gap-4 text-[14px] font-medium text-[#6B7280]">
                ...
                <div className="flex flex-col gap-5">
                    <h4 className="font-bold text-[#012126] text-md">Travel with Bago Bus</h4>
                    <div className="flex flex-col gap-4 text-[14px] font-medium text-[#6B7280]">
                ...
                <div className="flex flex-col gap-5">
                    <h4 className="font-bold text-[#012126] text-md">Find out more</h4>
                    <div className="flex flex-col gap-4 text-[14px] font-medium text-[#6B7280]">
            ...
            <div className="px-6 md:px-12 max-w-[1240px] mx-auto border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center text-[12px] font-medium text-[#6B7280]">
                <div className="flex gap-6 mb-4 md:mb-0">
                    <a href="#" className="hover:text-[#012126]">Terms and Conditions</a>
                    <a href="#" className="hover:text-[#012126]">Cookie settings</a>
                </div>
