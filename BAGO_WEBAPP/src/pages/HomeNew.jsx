    ...
    return (
        <nav className="w-full bg-white border-b border-gray-100 py-3 px-6 md:px-12 flex justify-between items-center z-50 sticky top-0 shadow-sm">
            ...
            <div className="hidden md:flex gap-10 items-center">
                <button onClick={() => navigate('/about')} className="text-[#012126] font-semibold hover:text-[#5845D8] transition-colors cursor-pointer text-[15px]">
                    {t('about') || 'Who we are'}
                </button>
                <button onClick={() => navigate('/how-it-works')} className="text-[#012126] font-semibold hover:text-[#5845D8] transition-colors cursor-pointer text-[15px]">
                    {t('howItWorks') || 'How it works'}
                </button>
                <button onClick={() => navigate('/track')} className="text-[#012126] font-semibold hover:text-[#5845D8] transition-colors cursor-pointer text-[15px]">
                    {t('track') || 'Track'}
                </button>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="relative">
                    ...
                    >
                        <Globe size={18} className="text-[#012126]" />
                        <span className="text-[22px]">{currentLangData?.flag}</span>
                        <span className="text-sm font-medium text-[#012126]">{currentLangData?.code?.toUpperCase()}</span>
                        <ChevronDown size={16} className={`text-[#012126] transition-transform ${showLangDropdown ? 'rotate-180' : ''}`} />
                    </button>
                ...
                {!isAuthenticated ? (
                    <div className="hidden md:flex items-center gap-3">
                        <button
                            ...
                            className="text-[#012126] font-bold text-[15px] px-6 py-2.5 rounded-full hover:bg-gray-50 transition-all"
                        >
                            {t('login') || 'Login'}
                        </button>
                        <button
                ...
                <button
                    ...
                    className="md:hidden text-[#012126] p-2"
                >
            ...
            {showMobileMenu && (
                <div className="absolute top-full left-0 right-0 bg-white border-t border-gray-100 shadow-lg md:hidden z-40">
                    <div className="flex flex-col p-6 space-y-4">
                        <button onClick={() => { navigate('/about'); setShowMobileMenu(false); }} className="text-[#012126] font-semibold text-left">
                            {t('about') || 'About'}
                        </button>
                        <button onClick={() => { navigate('/how-it-works'); setShowMobileMenu(false); }} className="text-[#012126] font-semibold text-left">
                            {t('howItWorks') || 'How it works'}
                        </button>
                        <button onClick={() => { navigate('/track'); setShowMobileMenu(false); }} className="text-[#012126] font-semibold text-left">
                            {t('track') || 'Track'}
                        </button>
                        {!isAuthenticated ? (
                            <>
                                <button onClick={() => { navigate('/login'); setShowMobileMenu(false); }} className="text-[#012126] font-bold">
                                    {t('login') || 'Login'}
                                </button>
            ...
            <div className="relative z-10 px-6 md:px-12 max-w-[1400px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center text-left">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-[56px] font-extrabold text-[#012126] mb-6 tracking-tight leading-[1.1]">
                            Move stuff. <br />
                            <span className="text-[#5845D8]">Make money.</span>
                        </h1>
                        <p className="text-[#6B7280] text-base md:text-lg font-medium mb-8 max-w-md leading-relaxed">
                        ...
                        <div className="flex flex-wrap gap-4 mb-10">
                            ...
                            <button
                                ...
                                className="px-8 py-3.5 bg-white border-2 border-gray-100 text-[#012126] font-bold rounded-xl text-[15px] hover:border-[#5845D8]/30 hover:bg-gray-50 transition-all"
                            >
                                How it works
                            </button>
                        </div>
...
const SearchSection = () => {
    ...
    const customSelectStyles = {
        ...
        singleValue: (base) => ({ ...base, color: '#012126', fontSize: '12px', fontWeight: '700' }),
                    ...
                    <div className="group flex items-center gap-3 px-5 py-3 rounded-2xl hover:bg-gray-50 transition-all border border-transparent hover:border-gray-100">
                        ...
                        <div className="flex-1">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent font-bold text-[#012126] text-[12px] outline-none cursor-pointer"
    ...
    return (
        <section className="px-6 md:px-12 max-w-[1200px] mx-auto py-16 mb-4">
            <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-[40px] font-bold text-[#012126] mb-4 tracking-tight">Safe, secure and seamless.</h2>
                <p className="text-base text-[#6B7280] max-w-xl mx-auto font-medium">We've built a platform based on trust and reliability.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {features.map((feature, idx) => (
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-[#012126] mb-3 relative z-10 tracking-tight">{feature.title}</h3>
                        <p className="text-[#6B7280] leading-relaxed font-medium text-sm relative z-10">{feature.desc}</p>
                    </motion.div>
                ))}
            </div>
        </section>
...
const FAQSection = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: "Upon successful delivery and recipient confirmation, funds are released to your Bago wallet immediately. You can withdraw through your connected payout method."
        },
        {
    ...
    return (
        <section className="px-6 md:px-12 max-w-[1240px] mx-auto py-16 bg-white">
            <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#012126] mt-6 leading-[1.1] tracking-tight">
            ...
            <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 opacity-30 grayscale filter invert-[0.1]">
                <div className="text-xl md:text-2xl font-black italic tracking-tighter text-[#012126]">DHL EXPRESS</div>
                <div className="text-xl md:text-2xl font-black italic tracking-tighter text-[#012126]">FEDEX GLOBAL</div>
                <div className="text-xl md:text-2xl font-black italic tracking-tighter text-[#012126]">UPS LOGISTICS</div>
                <div className="text-xl md:text-2xl font-black italic tracking-tighter text-[#012126]">AIR FRANCE</div>
                <div className="text-xl md:text-2xl font-black italic tracking-tighter text-[#012126]">EMIRATES SKY</div>
            </div>
        </section>
    );
};
