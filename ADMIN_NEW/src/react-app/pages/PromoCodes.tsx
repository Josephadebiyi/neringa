...
import { getPromoCodes, createPromoCode, togglePromoCode, deletePromoCode } from "../services/api";
...
export default function PromoCodes() {
    ...
    const toggleStatus = async (id: string) => {
        try {
            const data = await togglePromoCode(id);
            if (data.success) fetchPromoCodes();
        } catch (error) {
