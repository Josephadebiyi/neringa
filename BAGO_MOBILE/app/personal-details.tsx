...
import { User, Mail, Phone, MapPin, Calendar, Save, Lock, X, Camera, CreditCard } from 'lucide-react-native';
...
export default function PersonalDetailsScreen() {
  ...
  const handleSave = async () => {
    try {
      const updates: any = { email, phone, preferredCurrency };
          ...
          <View style={styles.form}>
            ...
            <View style={styles.field}>
              <View style={styles.labelRow}>
                ...
                {isKycLocked && <Lock size={14} color={'#6B6B6B'} />}
              </View>
            ...
            {/* Wallet Currency */}
            <View style={styles.field}>
              <Text style={styles.label}>Wallet Receiving Currency (Earnings)</Text>
              <View style={styles.inputContainer}>
                <CreditCard size={20} color={'#6B6B6B'} />
                <TextInput
                  style={styles.input}
              ...
              <Text style={styles.helperText}>
                The currency you will receive for your trip bookings.
              </Text>
            </View>
          </View>
