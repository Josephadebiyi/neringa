...
export default function SettingsPage() {
 ...
 try {
 setLoading(true);
 const response = await fetch('https://neringa.onrender.com/api/Adminbaggo/getCurrentSetting', {
 method: 'GET',
 ...
 try {
 setSaving(true);
 const response = await fetch('https://neringa.onrender.com/api/Adminbaggo/toggleAutoVerification', {
 method: 'PUT',
