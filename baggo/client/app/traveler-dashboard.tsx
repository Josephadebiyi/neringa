...
const styles = StyleSheet.create({
  ...
  miniStatValue: { fontSize: 24, fontWeight: 'bold', color: #111111, marginBottom: 4 },
  miniStatLabel: { fontSize: 12, color: #111111Light },
  tabBar: {
    flexDirection: 'row',
    marginHorizontal: 20,
  ...
  tabText: { fontSize: 14, fontWeight: '600', color: #111111Light },
  ...
  tripIcon: {
    ...
    backgroundColor: #F8F6F3Light, justifyContent: 'center',
    alignItems: 'center', marginRight: 12,
  },
  tripInfo: { flex: 1 },
  tripRoute: { fontSize: 16, fontWeight: '600', color: #111111, marginBottom: 4 },
  tripDate: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  tripDateText: { fontSize: 13, color: #111111Light },
  tripStats: {
  ...
  tripStatText: { fontSize: 13, color: #111111Light },
  requestBadge: {
    fontSize: 12, fontWeight: '600', color: #6366F1,
    backgroundColor: #F8F6F3Light, paddingHorizontal: 10,
    paddingVertical: 4, borderRadius: 12,
  },
  tripFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  earningsText: { fontSize: 14, color: #111111Light },
  earningsValue: { fontSize: 16, fontWeight: 'bold', color: #6366F1 },
  viewButton: {
  ...
  disabledButton: { backgroundColor: #111111Light, opacity: 0.5 },
...
editButtonText: {
  ...
  centerContent: { justifyContent: 'center', alignItems: 'center' },
  noTripsText: { fontSize: 16, color: #111111Light, textAlign: 'center', marginTop: 20 },
});
