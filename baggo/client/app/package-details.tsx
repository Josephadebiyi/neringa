...
const styles = StyleSheet.create({
  ...
  statusBadge: { alignSelf: 'flex-start', backgroundColor: '#86EFAC', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, marginBottom: 24 },
  ...
  timelineTitleInactive: { color: '#6B7280' },
  ...
  locationLabel: { fontSize: 13, color: '#6B7280', marginBottom: 4 },
  ...
  trackingNotes: { fontSize: 12, color: '#6B7280' },
  ...
  courierRole: { fontSize: 13, color: '#6B7280' },
  ...
  metaItem: { flex: 1 },
  metaLabel: { fontSize: 13, color: '#6B7280', marginBottom: 8 },
  metaBadge: { backgroundColor: '#86EFAC', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, alignSelf: 'flex-start' },
