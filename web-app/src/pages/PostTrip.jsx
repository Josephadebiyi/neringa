                            ...
                            <form onSubmit={handleFormNext} className="space-y-8">
                                <div className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                        <div className="space-y-6">
                                            <div>
                                                <label className="block text-[8px] font-black text-gray-400 uppercase mb-2 tracking-[0.15em] ml-1">{t('originCountry')}</label>
                                                <select
                                                    name="originCountry"
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                <label className="block text-[8px] font-black text-gray-400 uppercase mb-2 tracking-[0.15em] ml-1">{t('destCountry')}</label>
                                                <select
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-[8px] font-black text-gray-400 uppercase mb-2 tracking-[0.15em] ml-1">{t('departureLabel')}</label>
                                            <input
                                                type="date"
                                                name="departureDate"
                                        ...
                                        <div>
                                            <label className="block text-[8px] font-black text-gray-400 uppercase mb-2 tracking-[0.15em] ml-1">{t('arrivalLabel')}</label>
                                            <input
                                                type="date"
                                                name="arrivalDate"
                                ...
                                <div className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100">
                                    ...
                                    <div className="max-w-xs">
                                        <label className="block text-[8px] font-black text-gray-400 uppercase mb-2 tracking-[0.15em] ml-1">{t('availableWeightLabel')}</label>
                                        <div className="relative">
                                            <input
                                                type="number"
                        ...
                        <div className="lg:col-span-1">
                            <div className="space-y-6 sticky top-28">
                                <div className="bg-[#012126] rounded-[32px] p-8 text-white relative overflow-hidden shadow-xl">
                                    ...
                                    <p className="text-white/60 font-bold text-[10px] mb-8 leading-relaxed uppercase tracking-widest leading-relaxed">
                                        {t('postTripSub')}
                                    </p>
                        ...
                        <div className="bg-white rounded-[40px] shadow-sm border border-gray-100 overflow-hidden mb-10">
                            <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">{t('transportMode')}</p>
                                        <p className="text-xs font-black uppercase">{formData.transportMode}</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">{t('availableWeight')}</p>
                            ...
                            <div className="p-10 space-y-12">
                                <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative">
                                    <div className="text-center md:text-left flex-1">
                                        <p className="text-[9px] font-black text-[#5845D8] uppercase tracking-[3px] mb-3">{t('origin')}</p>
                                    ...
                                    <div className="text-center md:text-right flex-1">
                                        <p className="text-[9px] font-black text-[#5845D8] uppercase tracking-[3px] mb-3">{t('destination')}</p>
                                ...
                                {formData.additionalNotes && (
                                    <div className="bg-[#F8F6F3] p-6 rounded-3xl border border-gray-100">
                                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-2">{t('tripNotes')}</p>
