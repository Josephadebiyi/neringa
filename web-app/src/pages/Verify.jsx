                            ...
                            <div className="space-y-8 animate-in fade-in duration-500">
                                ...
                                <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 space-y-4">
                                    ...
                                    <ul className="space-y-3">
                                        {[
                                            { text: t('waitApproval') || 'Wait for our team to approve your ID', icon: <Clock size={14} /> },
                                            { text: t('checkDashboard') || 'Check your dashboard for live updates', icon: <ArrowRight size={14} /> }
                                        ].map((step, i) => (
