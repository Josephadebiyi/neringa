        ...
        <div className="min-h-screen bg-[#F8F6F3]">
            ...
            <div className="max-w-4xl mx-auto py-12 px-6 font-sans">
                <div className="mb-10 text-center">
                    <h1 className="text-3xl md:text-3xl font-black text-[#054752] mb-3 tracking-tight">Terms & Conditions</h1>
                ...
                <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-sm border border-gray-100 overflow-hidden relative">
                    ...
                    <div className="prose prose-slate max-w-none space-y-12">
                        ...
                        <section className="bg-blue-50/40 -mx-8 md:-mx-12 p-8 md:p-12 border-y border-blue-50/50">
                            ...
                            <p className="text-[#054752] leading-relaxed font-black text-[11px] mb-5 uppercase tracking-widest px-2 lg:px-4">
                                Safety and compliance are our non-negotiable standards.
                            </p>
                            <ul className="text-[#708c91] leading-relaxed font-bold space-y-3 list-none p-0 px-2 lg:px-4">
                        ...
                        <section>
                            ...
                            <p className="text-[#708c91] leading-relaxed font-bold text-[12px] uppercase tracking-wide opacity-80 px-2 lg:px-4">
                                ...
                                <br /><br />
                                <strong className="text-[#054752] font-black">Duplicate Accounts:</strong> Users are permitted only one verified account. Attempting to create multiple identities or bypass security checks will result in a permanent ban.
                            </p>
                        </section>
                        ...
                        <section className="bg-purple-50/40 -mx-8 md:-mx-12 p-8 md:p-12 border-y border-purple-50/50 text-[12px]">
                            ...
                            <p className="text-[#708c91] leading-relaxed font-bold uppercase tracking-wide opacity-80 px-2 lg:px-4 mb-5">
                        ...
                        <section className="px-2 lg:px-4">
                            <h2 className="text-base font-black text-[#054752] mb-4 uppercase tracking-tight">5. Prohibitions</h2>
